...
public class UtilClass {
    ...
    public static void main(String[] args) {
        // 获取特定包下所有的类(包括接口和类)
//        List<Class<?>> clsList = UtilClass.getAllClassByPackageName(PlatformConsoleStarter.class.getPackage());
        //输出所有使用了特定注解的类的注解值
//        AnnotationUtil.validAnnotation(clsList, AuthResource.class);
    }
}
